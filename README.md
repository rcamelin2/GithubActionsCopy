[![Run App RileyCamelin](https://github.com/rcamelin2/GithubActionsCopy/actions/workflows/run-app.yaml/badge.svg)](https://github.com/rcamelin2/GithubActionsCopy/actions/workflows/run-app.yaml)
